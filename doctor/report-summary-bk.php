	...
	if ($_POST) {
		...
		if (isset($_POST["filter"])) {
			if ($_POST["showonly"] == 'all') {
				...
				$sqlmain = "select patient.*,monitor1.* from patient
				left JOIN monitor1 on patient.pcid = monitor1.pcid
				GROUP BY monitor1.pcid";
				$selecttype = "All";
...
?>
	...
	<form action="report-summary-indiv.php" method="post" name="form1">
		...
		<?
			$sqlmain="SELECT * FROM monitor1 ORDER BY pcid ASC";
		...
		<select name="week" class="btn btn-success">
			...
			<!-- <option value="<?=$row["week"];?>"> Week 24 </option>
			<option value="<?=$row["week"];?>"> Week 25 </option>
			<option value="<?=$row["week"];?>"> Week 26 </option>
			<option value="<?=$row["week"];?>"> Week 27 </option>
			<option value="<?=$row["week"];?>"> Week 28 </option>
			<option value="<?=$row["week"];?>"> Week 29 </option>
			<option value="<?=$row["week"];?>"> Week 30 </option>
			<option value="<?=$row["week"];?>"> Week 31 </option>
			<option value="<?=$row["week"];?>"> Week 32 </option>
			<option value="<?=$row["week"];?>"> Week 33 </option>
			<option value="<?=$row["week"];?>"> Week 34 </option>
			<option value="<?=$row["week"];?>"> Week 35 </option>
			<option value="<?=$row["week"];?>"> Week 36 </option>
			<option value="<?=$row["week"];?>"> Week 37 </option>
			<option value="<?=$row["week"];?>"> Week 38 </option> -->
			</select>
