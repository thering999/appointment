                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        รายงานภาพรวมความปกติ/ผิดปกติในระบบ (Chart1)

                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        เข้าถึงรายงานคลิกที่ <front style="color:#FF0000"><b>Show all Report Chart1.</b></front>
                                    </p>
                                ...
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        รายงานความผิดปกติแยกตามด้านต่างๆ ใน รพสต (Chart2)
                                    </p>
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        เข้าถึงรายงานคลิกที่ <front style="color:#FF0000"><b>Show all Report Chart2.</b></front>
                                    </p>
                                </td>
                                ...
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                    รายงานความผิดปกติแยกตามด้านต่างๆ ใน รพ (Chart3)
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        เข้าถึงรายงานคลิกที่ <front style="color:#FF0000"><b>Show all Report Chart3.</b></front>
                                    </p>
                                ...
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                    รายงานภาพแยกรายหน่วยบริการ (Chart4)
                                    </p>
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        เข้าถึงรายงานคลิกที่ <front style="color:#FF0000"><b>Show all Report Chart4.</b></front>
                                    </p>
                                </td>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        เข้าถึงรายงานคลิกที่ <front style="color:#FF0000"><b>Show all Report Summary.</b></front>
                                    </p>
                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today'  and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc";
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">ไม่พบการนัดหมายในระบบ !</p>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select schedule.scheduleid,schedule.title,doctor.docname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today' and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc"; 
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">ไม่พบ คิวงานเจ้าหน้าที่ในระบบ !</p>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="report-chart1.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Report Chart1</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="report-chart2.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Report Chart2</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="report-chart3.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Report Chart3</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="report-chart4.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show all Report Chart4</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="report-summary.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Show Report Summary</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
