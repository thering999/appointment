                ...
                <tr>
                   <td colspan="4">
                       <center>
                        ...
                        <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">ตารางลงนัดหมาย</p>                 
                        </td>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <br>
                                                            <a href="booking.php?id='.$scheduleid.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">ลงนัดหมาย</font></button></a>
                                                    </div>
