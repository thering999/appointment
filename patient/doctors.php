                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=session&id='.$docid.'&name='.$name.'"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">ดูตารางการทำงาน</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">รายละเอียดเจ้าหน้าที่.</p><br><br>
                                </td>
                            </tr>
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>เปลี่ยนดูตารางทำงานของเจ้าหน้าที่?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                            ท่านต้องการดูตารางการทำงานของเจ้าหน้าที่ชื่อ <br>('.substr($name,0,40).').
                        ...
                        <input type="submit"  value="ตกลง" class="btn-primary btn"   >
