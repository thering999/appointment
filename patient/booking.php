                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        <div class="h1-search" style="font-size:25px;">
                                                            รายละเอียดการนัดหมายเจ้าหน้าที่
                                                        </div><br><br>
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            ชื่อเจ้าหน้าที่:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Email:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ชือการนัดหมาย (Session Title): '.$title.'<br>
                                                            วันที่นัดหมาย (Session Scheduled Date): '.$scheduledate.'<br>
                                                            เริ่มนัดหมายช่วงที่ (Session Starts): '.$scheduletime.'<br>
                                                            </b>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="ตกลงนัดหมาย" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
